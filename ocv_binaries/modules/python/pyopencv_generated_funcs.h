...
static PyObject* pyopencv_BRISK_BRISK(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|iif:BRISK", (char**)keywords, &thresh, &octaves, &patternScale) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::BRISK(thresh, octaves, patternScale)));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
        ...
        pyopencv_to(pyobj_indexChange, indexChange, ArgInfo("indexChange", 0)) )
    {
        self = PyObject_NEW(pyopencv_BRISK_t, &pyopencv_BRISK_Type);
        new (&(self->v)) Ptr<cv::BRISK>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::BRISK(radiusList, numberList, dMax, dMin, indexChange)));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_CascadeClassifier_convert(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    {
        ERRWRAP2(retval = CascadeClassifier::convert(oldcascade, newcascade));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_CvANN_MLP_CvANN_MLP(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new CvANN_MLP()));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
        ...
        pyopencv_to(pyobj_layerSizes, layerSizes, ArgInfo("layerSizes", 0)) )
    {
        self = PyObject_NEW(pyopencv_CvANN_MLP_t, &pyopencv_CvANN_MLP_Type);
        new (&(self->v)) Ptr<CvANN_MLP>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new CvANN_MLP(layerSizes, activateFunc, fparam1, fparam2)));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_CvBoost_CvBoost(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new CvBoost()));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
        ...
        pyopencv_to(pyobj_params, params, ArgInfo("params", 0)) )
    {
        self = PyObject_NEW(pyopencv_CvBoost_t, &pyopencv_CvBoost_Type);
        new (&(self->v)) Ptr<CvBoost>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new CvBoost(trainData, tflag, responses, varIdx, sampleIdx, varType, missingDataMask, params)));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_CvDTree_CvDTree(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new CvDTree()));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_CvERTrees_CvERTrees(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new CvERTrees()));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_CvGBTrees_CvGBTrees(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new CvGBTrees()));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
        ...
        pyopencv_to(pyobj_params, params, ArgInfo("params", 0)) )
    {
        self = PyObject_NEW(pyopencv_CvGBTrees_t, &pyopencv_CvGBTrees_Type);
        new (&(self->v)) Ptr<CvGBTrees>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new CvGBTrees(trainData, tflag, responses, varIdx, sampleIdx, varType, missingDataMask, params)));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_CvKNearest_CvKNearest(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new CvKNearest()));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
        ...
        pyopencv_to(pyobj_sampleIdx, sampleIdx, ArgInfo("sampleIdx", 0)) )
    {
        self = PyObject_NEW(pyopencv_CvKNearest_t, &pyopencv_CvKNearest_Type);
        new (&(self->v)) Ptr<CvKNearest>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new CvKNearest(trainData, responses, sampleIdx, isRegression, max_k)));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_CvNormalBayesClassifier_CvNormalBayesClassifier(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new CvNormalBayesClassifier()));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
        ...
        pyopencv_to(pyobj_sampleIdx, sampleIdx, ArgInfo("sampleIdx", 0)) )
    {
        self = PyObject_NEW(pyopencv_CvNormalBayesClassifier_t, &pyopencv_CvNormalBayesClassifier_Type);
        new (&(self->v)) Ptr<CvNormalBayesClassifier>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new CvNormalBayesClassifier(trainData, responses, varIdx, sampleIdx)));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_CvRTrees_CvRTrees(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new CvRTrees()));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_CvSVM_CvSVM(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new CvSVM()));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
        ...
        pyopencv_to(pyobj_params, params, ArgInfo("params", 0)) )
    {
        self = PyObject_NEW(pyopencv_CvSVM_t, &pyopencv_CvSVM_Type);
        new (&(self->v)) Ptr<CvSVM>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new CvSVM(trainData, responses, varIdx, sampleIdx, params)));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_DenseFeatureDetector_DenseFeatureDetector(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    pyopencv_DenseFeatureDetector_t* self = 0;

    const char* keywords[] = { "initFeatureScale", "featureScaleLevels", "featureScaleMul", "initXyStep", "initImgBound", "varyXyStepWithScale", "varyImgBoundWithScale", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|fifiibb:DenseFeatureDetector", (char**)keywords, &initFeatureScale, &featureScaleLevels, &featureScaleMul, &initXyStep, &initImgBound, &varyXyStepWithScale, &varyImgBoundWithScale) )
    {
        self = PyObject_NEW(pyopencv_DenseFeatureDetector_t, &pyopencv_DenseFeatureDetector_Type);
        new (&(self->v)) Ptr<cv::DenseFeatureDetector>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::DenseFeatureDetector(initFeatureScale, featureScaleLevels, featureScaleMul, initXyStep, initImgBound, varyXyStepWithScale, varyImgBoundWithScale)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_softcascade_Detector_Detector(PyObject* , PyObject* args, PyObject* kw)
{
    double minScale=0.4;
    double maxScale=5.;
    int scales=55;
    int rejCriteria=1;
    pyopencv_softcascade_Detector_t* self = 0;

    const char* keywords[] = { "minScale", "maxScale", "scales", "rejCriteria", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|ddii:Detector", (char**)keywords, &minScale, &maxScale, &scales, &rejCriteria) )
    {
        self = PyObject_NEW(pyopencv_softcascade_Detector_t, &pyopencv_softcascade_Detector_Type);
        new (&(self->v)) Ptr<cv::softcascade::Detector>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::softcascade::Detector(minScale, maxScale, scales, rejCriteria)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_EM_EM(PyObject* , PyObject* args, PyObject* kw)
{
        ...
        pyopencv_to(pyobj_termCrit, termCrit, ArgInfo("termCrit", 0)) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::EM(nclusters, covMatType, termCrit)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_FastFeatureDetector_FastFeatureDetector(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|ib:FastFeatureDetector", (char**)keywords, &threshold, &nonmaxSuppression) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::FastFeatureDetector(threshold, nonmaxSuppression)));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "ibi:FastFeatureDetector", (char**)keywords, &threshold, &nonmaxSuppression, &type) )
    {
        self = PyObject_NEW(pyopencv_FastFeatureDetector_t, &pyopencv_FastFeatureDetector_Type);
        new (&(self->v)) Ptr<cv::FastFeatureDetector>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::FastFeatureDetector(threshold, nonmaxSuppression, type)));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_FlannBasedMatcher_FlannBasedMatcher(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    Ptr_flann_IndexParams indexParams=makePtr<flann::KDTreeIndexParams>();
    PyObject* pyobj_searchParams = NULL;
    Ptr_flann_SearchParams searchParams=makePtr<flann::SearchParams>();
...
static PyObject* pyopencv_GFTTDetector_GFTTDetector(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|iddibd:GFTTDetector", (char**)keywords, &maxCorners, &qualityLevel, &minDistance, &blockSize, &useHarrisDetector, &k) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::GFTTDetector(maxCorners, qualityLevel, minDistance, blockSize, useHarrisDetector, k)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_GridAdaptedFeatureDetector_GridAdaptedFeatureDetector(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    Ptr_FeatureDetector detector=Ptr<FeatureDetector>();
        ...
        pyopencv_to(pyobj_detector, detector, ArgInfo("detector", 0)) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::GridAdaptedFeatureDetector(detector, maxTotalKeypoints, gridRows, gridCols)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_KDTree_KDTree(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::KDTree()));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
        ...
        pyopencv_to(pyobj_points, points, ArgInfo("points", 0)) )
    {
        self = PyObject_NEW(pyopencv_KDTree_t, &pyopencv_KDTree_Type);
        new (&(self->v)) Ptr<cv::KDTree>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::KDTree(points, copyAndReorderPoints)));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
        ...
        pyopencv_to(pyobj__labels, _labels, ArgInfo("_labels", 0)) )
    {
        self = PyObject_NEW(pyopencv_KDTree_t, &pyopencv_KDTree_Type);
        new (&(self->v)) Ptr<cv::KDTree>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::KDTree(points, _labels, copyAndReorderPoints)));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_KeyPoint_convert(PyObject* , PyObject* args, PyObject* kw)
{
    {
    ...
    {
        ERRWRAP2(KeyPoint::convert(keypoints, points2f, keypointIndexes));
    ...
    {
        ERRWRAP2(KeyPoint::convert(points2f, keypoints, size, response, octave, class_id));
...
static PyObject* pyopencv_KeyPoint_overlap(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    {
        ERRWRAP2(retval = KeyPoint::overlap(kp1, kp2));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_MSER_MSER(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|iiiddiddi:MSER", (char**)keywords, &_delta, &_min_area, &_max_area, &_max_variation, &_min_diversity, &_max_evolution, &_area_threshold, &_min_margin, &_edge_blur_size) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::MSER(_delta, _min_area, _max_area, _max_variation, _min_diversity, _max_evolution, _area_threshold, _min_margin, _edge_blur_size)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_ORB_ORB(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|ifiiiiii:ORB", (char**)keywords, &nfeatures, &scaleFactor, &nlevels, &edgeThreshold, &firstLevel, &WTA_K, &scoreType, &patchSize) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::ORB(nfeatures, scaleFactor, nlevels, edgeThreshold, firstLevel, WTA_K, scoreType, patchSize)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_PyramidAdaptedFeatureDetector_PyramidAdaptedFeatureDetector(PyObject* , PyObject* args, PyObject* kw)
{
        ...
        pyopencv_to(pyobj_detector, detector, ArgInfo("detector", 0)) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::PyramidAdaptedFeatureDetector(detector, maxLevel)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_SIFT_SIFT(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|iiddd:SIFT", (char**)keywords, &nfeatures, &nOctaveLayers, &contrastThreshold, &edgeThreshold, &sigma) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::SIFT(nfeatures, nOctaveLayers, contrastThreshold, edgeThreshold, sigma)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_SURF_SURF(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::SURF()));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "d|iibb:SURF", (char**)keywords, &hessianThreshold, &nOctaves, &nOctaveLayers, &extended, &upright) )
    {
        self = PyObject_NEW(pyopencv_SURF_t, &pyopencv_SURF_Type);
        new (&(self->v)) Ptr<cv::SURF>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::SURF(hessianThreshold, nOctaves, nOctaveLayers, extended, upright)));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_SimpleBlobDetector_SimpleBlobDetector(PyObject* , PyObject* args, PyObject* kw)
{
        ...
        pyopencv_to(pyobj_parameters, parameters, ArgInfo("parameters", 0)) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::SimpleBlobDetector(parameters)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_StarDetector_StarDetector(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|iiiii:StarDetector", (char**)keywords, &_maxSize, &_responseThreshold, &_lineThresholdProjected, &_lineThresholdBinarized, &_suppressNonmaxSize) )
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::StarDetector(_maxSize, _responseThreshold, _lineThresholdProjected, _lineThresholdBinarized, _suppressNonmaxSize)));
        return (PyObject*)self;
    }
...
static PyObject* pyopencv_StereoVar_StereoVar(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ...
        if(self) ERRWRAP2(self->v.reset(new cv::StereoVar()));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "idiiiidffiii:StereoVar", (char**)keywords, &levels, &pyrScale, &nIt, &minDisp, &maxDisp, &poly_n, &poly_sigma, &fi, &lambda, &penalization, &cycle, &flags) )
    {
        self = PyObject_NEW(pyopencv_StereoVar_t, &pyopencv_StereoVar_Type);
        new (&(self->v)) Ptr<cv::StereoVar>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::StereoVar(levels, pyrScale, nIt, minDisp, maxDisp, poly_n, poly_sigma, fi, lambda, penalization, cycle, flags)));
        return (PyObject*)self;
    }
    }
...
static PyObject* pyopencv_VideoWriter_fourcc(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    {
        ERRWRAP2(retval = VideoWriter::fourcc(c1, c2, c3, c4));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_boxPoints(PyObject* , PyObject* args, PyObject* kw)
{
...
static PyObject* pyopencv_colorChange(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_src = NULL;
    Mat src;
    PyObject* pyobj_mask = NULL;
...
static PyObject* pyopencv_connectedComponents(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_image = NULL;
    Mat image;
...
static PyObject* pyopencv_connectedComponentsWithStats(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_image = NULL;
    Mat image;
    PyObject* pyobj_labels = NULL;
...
static PyObject* pyopencv_createAlignMTB(PyObject* , PyObject* args, PyObject* kw)
{
    int max_bits=6;
    int exclude_range=4;
    bool cut=true;
...
static PyObject* pyopencv_createBackgroundSubtractorGMG(PyObject* , PyObject* args, PyObject* kw)
{
    int initializationFrames=120;
    double decisionThreshold=0.8;
    Ptr_BackgroundSubtractorGMG retval;
    ...
    {
        ERRWRAP2(retval = cv::createBackgroundSubtractorGMG(initializationFrames, decisionThreshold));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_createBackgroundSubtractorKNN(PyObject* , PyObject* args, PyObject* kw)
{
    int history=500;
    double dist2Threshold=400.0;
    bool detectShadows=true;
    Ptr_BackgroundSubtractorKNN retval;
...
static PyObject* pyopencv_createBackgroundSubtractorMOG(PyObject* , PyObject* args, PyObject* kw)
{
    int history=200;
    int nmixtures=5;
    double backgroundRatio=0.7;
    double noiseSigma=0;
    Ptr_BackgroundSubtractorMOG retval;
    ...
    {
        ERRWRAP2(retval = cv::createBackgroundSubtractorMOG(history, nmixtures, backgroundRatio, noiseSigma));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_createBackgroundSubtractorMOG2(PyObject* , PyObject* args, PyObject* kw)
{
    int history=500;
    double varThreshold=16;
    bool detectShadows=true;
    Ptr_BackgroundSubtractorMOG2 retval;
...
static PyObject* pyopencv_createCalibrateDebevec(PyObject* , PyObject* args, PyObject* kw)
{
    int samples=70;
    float lambda=10.0f;
    bool random=false;
...
static PyObject* pyopencv_createCalibrateRobertson(PyObject* , PyObject* args, PyObject* kw)
{
    int max_iter=30;
...
static PyObject* pyopencv_createLineSegmentDetector(PyObject* , PyObject* args, PyObject* kw)
{
...
static PyObject* pyopencv_createMergeDebevec(PyObject* , PyObject* args, PyObject* kw)
{
    Ptr_MergeDebevec retval;
...
static PyObject* pyopencv_createMergeMertens(PyObject* , PyObject* args, PyObject* kw)
{
    float contrast_weight=1.0f;
    float saturation_weight=1.0f;
    float exposure_weight=0.0f;
    Ptr_MergeMertens retval;
...
static PyObject* pyopencv_createMergeRobertson(PyObject* , PyObject* args, PyObject* kw)
{
    Ptr_MergeRobertson retval;
...
static PyObject* pyopencv_createStereoBM(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|ii:createStereoBM", (char**)keywords, &numDisparities, &blockSize) )
    {
        ERRWRAP2(retval = cv::createStereoBM(numDisparities, blockSize));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_createStereoSGBM(PyObject* , PyObject* args, PyObject* kw)
{
    int minDisparity=0;
    int numDisparities=0;
    int blockSize=0;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "iii|iiiiiiii:createStereoSGBM", (char**)keywords, &minDisparity, &numDisparities, &blockSize, &P1, &P2, &disp12MaxDiff, &preFilterCap, &uniquenessRatio, &speckleWindowSize, &speckleRange, &mode) )
    {
        ERRWRAP2(retval = cv::createStereoSGBM(minDisparity, numDisparities, blockSize, P1, P2, disp12MaxDiff, preFilterCap, uniquenessRatio, speckleWindowSize, speckleRange, mode));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_createTonemap(PyObject* , PyObject* args, PyObject* kw)
{
    float gamma=1.0f;
    Ptr_Tonemap retval;
...
static PyObject* pyopencv_createTonemapDrago(PyObject* , PyObject* args, PyObject* kw)
{
    float gamma=1.0f;
...
static PyObject* pyopencv_createTonemapDurand(PyObject* , PyObject* args, PyObject* kw)
{
    float gamma=1.0f;
    float contrast=4.0f;
    float saturation=1.0f;
...
static PyObject* pyopencv_createTonemapMantiuk(PyObject* , PyObject* args, PyObject* kw)
{
    float gamma=1.0f;
    float scale=0.7f;
    float saturation=1.0f;
    Ptr_TonemapMantiuk retval;
...
static PyObject* pyopencv_createTonemapReinhard(PyObject* , PyObject* args, PyObject* kw)
{
    float gamma=1.0f;
...
static PyObject* pyopencv_decolor(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_src = NULL;
    Mat src;
...
static PyObject* pyopencv_decomposeEssentialMat(PyObject* , PyObject* args, PyObject* kw)
{
...
static PyObject* pyopencv_demosaicing(PyObject* , PyObject* args, PyObject* kw)
{
...
static PyObject* pyopencv_detailEnhance(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_src = NULL;
    Mat src;
    PyObject* pyobj_dst = NULL;
...
static PyObject* pyopencv_drawMatches(PyObject* , PyObject* args, PyObject* kw)
{
...
static PyObject* pyopencv_drawMatchesKnn(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_img1 = NULL;
    Mat img1;
    PyObject* pyobj_keypoints1 = NULL;
...
static PyObject* pyopencv_edgePreservingFilter(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_src = NULL;
    Mat src;
    PyObject* pyobj_dst = NULL;
...
static PyObject* pyopencv_findCirclesGrid(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    Ptr_FeatureDetector blobDetector=makePtr<SimpleBlobDetector>();
    bool retval;
...
static PyObject* pyopencv_findEssentialMat(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_points1 = NULL;
    Mat points1;
    PyObject* pyobj_points2 = NULL;
...
static PyObject* pyopencv_findTransformECC(PyObject* , PyObject* args, PyObject* kw)
{
...
static PyObject* pyopencv_illuminationChange(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_src = NULL;
    Mat src;
    PyObject* pyobj_mask = NULL;
...
static PyObject* pyopencv_linearPolar(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_src = NULL;
    Mat src;
    PyObject* pyobj_dst = NULL;
...
static PyObject* pyopencv_logPolar(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_src = NULL;
    Mat src;
    PyObject* pyobj_dst = NULL;
...
static PyObject* pyopencv_minEnclosingTriangle(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_points = NULL;
    Mat points;
...
static PyObject* pyopencv_pencilSketch(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_src = NULL;
    Mat src;
...
static PyObject* pyopencv_recoverPose(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_E = NULL;
    Mat E;
    PyObject* pyobj_points1 = NULL;
...
static PyObject* pyopencv_rotatedRectangleIntersection(PyObject* , PyObject* args, PyObject* kw)
{
...
static PyObject* pyopencv_seamlessClone(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_src = NULL;
    Mat src;
    PyObject* pyobj_dst = NULL;
...
static PyObject* pyopencv_softcascade_ChannelFeatureBuilder_create(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_featureType = NULL;
    String featureType;
    Ptr_ChannelFeatureBuilder retval;

    const char* keywords[] = { "featureType", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:softcascade_ChannelFeatureBuilder_create", (char**)keywords, &pyobj_featureType) &&
        pyopencv_to(pyobj_featureType, featureType, ArgInfo("featureType", 0)) )
    {
        ERRWRAP2(retval = softcascade_ChannelFeatureBuilder::create(featureType));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_sqrBoxFilter(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj__src = NULL;
    Mat _src;
    PyObject* pyobj__dst = NULL;
...
static PyObject* pyopencv_stylization(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_src = NULL;
    Mat src;
    PyObject* pyobj_dst = NULL;
...
static PyObject* pyopencv_textureFlattening(PyObject* , PyObject* args, PyObject* kw)
{
    PyObject* pyobj_src = NULL;
    Mat src;
    PyObject* pyobj_mask = NULL;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|Oddi:textureFlattening", (char**)keywords, &pyobj_src, &pyobj_mask, &pyobj_dst, &low_threshold, &high_threshold, &kernel_size) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_mask, mask, ArgInfo("mask", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 1)) )
    {
